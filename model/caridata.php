                ...
                <td style="padding: 10px;">
                    ...
                    <div class="container" style="height: 100%; display: flex; justify-content: center; align-items: center;">
                        <div style="top: 50%; transform:translate(0, -50%); position: absolute;">
                            <div class="well">
                                <p align="center"><img src="images/logo_sma.png" height="75" /></p>
                                <h4 align="center" style="margin: 15px 0 -10px 0;"><b>STATUS KELULUSAN SISWA</br>SMA NEGERI 1 TUREN</b></h4>
                                <hr>
                                <script>
                                    function cekNo() {
        ...
        $('#clock').countdown("<?= $tgl_pengumuman; ?>", {
            ...
            .on('update.countdown', function(event) {
                ...
                if (event.elapsed) {
                    ...
                    $this.html(event.strftime('<strong>WAKTU PENGUMUMAN KELULUSAN </br>%D HARI %H JAM %M MENIT %S DETIK</strong>'));
                    $("#xpengumuman").hide();
                }
            });
    </script>
